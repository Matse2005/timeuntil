...
<body>
  <div class='container'>
    <div class='links-container'>
      <h1><?php print $NAME ?> <?php print $TITLE_SEPARATOR ?> Edit Coundonws</h1>
      <?php
      ...
      foreach ($results as $row) {
        print "<li class='" . $align . "'><a class='link' href='/edit/" . $row['slug'] . "'>" . $row['name'] . "</a></li>";
        $align = $align == "left" ? "right" : "left";
      }
      ?>
      <?php $align = $align == "left" ? "right" : "left"; ?>
      <li class='<?php print $align ?>'><a class='link' href='/dashboard'>Go back</a></li>
    </div>
  </div>

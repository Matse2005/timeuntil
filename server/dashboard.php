...
<head>
  ...
  <title><?php print $NAME ?> <?php print $TITLE_SEPARATOR ?> Admin <?php print $TITLE_SEPARATOR ?> Dashboard</title>
...
<body>
  <div class='container'>
    <div class='links-container'>
      <h1><?php print $NAME ?> <?php print $TITLE_SEPARATOR ?> Dashboard</h1>
      <li class='right'><a class='link' href='/add'>Add Countdows</a></li>
      <li class='left'><a class='link' href='/edit'>Edit Countdows</a></li>
      <!-- <li class='right'><a class='link' href='/settings'>Manage Settings</a></li>
      <li class='left'><a class='link' href='/password'>Manage Password</a></li> -->
      <li class='right'><a class='link' href='/logout'>Logout</a></li>
    </div>
  </div>

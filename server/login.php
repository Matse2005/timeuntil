...
<head>
  ...
  <title><?php print $NAME ?> <?php print $TITLE_SEPARATOR ?> Admin <?php print $TITLE_SEPARATOR ?> Login</title>
...
<body>
  <div class="login-page">
    <div class="form">
      ...
      <h1><?php print $NAME ?> <?php print $TITLE_SEPARATOR ?> Login</h1>
      <form method="POST" action="/controller/auth.php" class="login-form">
